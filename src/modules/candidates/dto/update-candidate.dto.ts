...
class ExperienceDto {
  ...
  @ApiPropertyOptional({ example: 'Built scalable services' })
  description?: string;
  @ApiPropertyOptional({ example: '2022-01' }) startDate?: string;
  @ApiPropertyOptional({ example: '2024-06', nullable: true }) endDate?:
    | string
    | null;
...
class EducationDto {
  ...
  @ApiPropertyOptional({ example: 'University of Wollongong' })
  institution?: string;
...
export class UpdateCandidateDto {
  ...
  @ApiPropertyOptional({ example: '78 Nothing street nowhere place 2898' })

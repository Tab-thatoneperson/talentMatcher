...
- Use Today's date provided above to caclulate  relevant years of experience. You can assume the start of a skill  as startDate of job when it is mentioned and it keeps increasing. 
